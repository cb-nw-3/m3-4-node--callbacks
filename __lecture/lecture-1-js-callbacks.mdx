...
do multiple thing at the same time.
...
network request, its able to multitask

---

<img src='./assets/async_sync.png' style='width: 100%;' />
black circle code start doing stuff
blue line Done
red line blocked
---
...
when you have code in synchronous model
---
...
passing it whenever the function deside
...
both, depend on how you use it.

function log() { console.log('yes I am running):}
synchronous
with forEach
